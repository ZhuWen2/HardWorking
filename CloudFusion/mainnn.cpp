...
int main()
{
	...
	for (int i = 1; i < 2; ++i) {
		...
		string fileName1 = "C:\\Users\\123456\\Desktop\\测试工件\\线激光\\工件1配准\\overlapped1.ply";
		pcl::io::loadPLYFile(fileName1, *pPntCloud1);

		pcl::PointCloud<pcl::PointXYZ>::Ptr pPntCloud2(new pcl::PointCloud<pcl::PointXYZ>);
		string fileName2 = "C:\\Users\\123456\\Desktop\\测试工件\\线激光\\工件1配准\\overlapped2.ply";
		...
		km.Mix("C:\\Users\\123456\\Desktop\\测试工件\\线激光\\工件1配准", "融合前降", i, i + 1);
		clock_t end = clock();
