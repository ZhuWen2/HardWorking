...
void CF::PCS(int i)
{
	...
	fileName3 = "C:\\Users\\123456\\Desktop\\测试工件\\线激光\\工件1配准\\融合前降" + to_string(i) + ".ply";
	...
	// 执行采样并带出采样结果
	nss1.filter(*target);
	pcl::io::savePLYFileASCII("C:\\Users\\123456\\Desktop\\测试工件\\线激光\\工件1配准\\jjjj.ply", *target);
	//四点法配准
...
void CF::calaPointCloudCoincide(int m, int n, pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_src, pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_target, float para1)
{
	...
	pcl::io::savePLYFile("C:\\Users\\123456\\Desktop\\测试工件\\线激光\\工件1配准\\overlapped1.ply", *overlapped1);
	pcl::io::savePLYFile("C:\\Users\\123456\\Desktop\\测试工件\\线激光\\工件1配准\\overlapped2.ply", *overlapped2);
...
void CF::find_corr(int m, int n) {
	...
	for (int i = 1; i < 2; ++i) {
		...
		string fileName1 = "C:\\Users\\123456\\Desktop\\测试工件\\线激光\\工件1配准\\融合前降" + to_string(m) + ".ply";
		...
		for (int j = i + 1; j < 3; ++j) {
			...
			string fileName2 = "C:\\Users\\123456\\Desktop\\测试工件\\线激光\\工件1配准\\融合前降" + to_string(n) + ".ply";
...
bool KMeans::Mix(const string dir_name, const string prex_name, int a, int b) {
	...
	string fileName1 = "C:\\Users\\123456\\Desktop\\测试工件\\线激光\\工件1配准\\融合前降" + to_string(a) + ".ply";
	pcl::io::loadPLYFile(fileName1, *cloud1);
	pcl::PointCloud<pcl::PointXYZ>::Ptr cloud2(new pcl::PointCloud<pcl::PointXYZ>);
	string fileName2 = "C:\\Users\\123456\\Desktop\\测试工件\\线激光\\工件1配准\\融合前降" + to_string(b) + ".ply";
